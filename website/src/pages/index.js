...
const IndexPage = () => (
  <main>
    <section className='mw9 center ph4 ph6-l pv3 pt4-l mt3-l flex-l items-center justify-between tc tl-l'>
      <img className='order-1' src='./assets/Bulb_illustration.png' alt='' />
      <div>
    ...
    <section className='mw9 center ph4 ph6-l pv3 pv4-ns tc'>
    ...
    <section className='bg-mh-gray pa4 tc'>
      <div className='mw9 center flex flex-wrap justify-center pv3 mb4 ph6-l'>
        ...
        <div className='w4 h4 bg-white br-100 pa3 ma3 ma4-ns content-box'>
          ...
          <p className='lh-copy'>Training Sessions</p>
        </div>
        <p className='f3'>… and worked with over 20 clients globally…</p>
        <div className='flex items-center justify-center flex-wrap'>
          <img className='ma4' src='./assets/client_Gojek.png' alt='Gojek' />
          <img className='ma4' src='./assets/client_thoughtworks.png' alt='ThoughtWorks' />
          <img className='ma4' src='./assets/client_scripbox.png' alt='scripbox' />
          <img className='ma4' src='./assets/icon_grasshopper.png' alt='grasshopper' />
          <img className='ma4' src='./assets/client_housing.png' alt='housing' />
          <img className='ma4' src='./assets/client_flipkart.png' alt='flipkart' />
          <img className='ma4' src='./assets/client_zinc.png' alt='zinc' />
          <img className='ma4' src='./assets/client_barkloudly.png' alt='barklougly' />
          <img className='ma4' src='./assets/client_thearc.png' alt='the arc' />
          <img className='ma4' src='./assets/icon_synup.png' alt='synup' />
          <img className='ma4' src='./assets/client_ashoka.png' alt='ashoka' />
        </div>
      </div>
    </section>

    <div className='mw9 center'>
      <section className='mv4 pv3 ph6-l'>

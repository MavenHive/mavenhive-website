  ...
  return (
    <div>
      <div className='mw-mavenhive center ph4 mt5 pt3'>
        <h1 className="f2 normal">&ldquo;We build solution for users problems.&rdquo;</h1>
        <p className="measure-mh lh-mh f-1 mb4 mb5-l mh-gray">We combine our software and product craftsmanship with our client’s disruptive ideas to achieve their business goals with high ROI</p>
      </div>
...
export const pageQuery = graphql`
  query serviceQuery($path: String!) {

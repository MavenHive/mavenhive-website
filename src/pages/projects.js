...
export default () => (
  <div>
    ...
    <section className="mw-mavenhive center ph4 mt5 pt3 flex-l items-center justify-between">
      ...
      <div className="mb6">
        ...
        <p className="measure-mh lh-mh-1 f5 tracked-mh mb4 mb5-l mh-gray">
          E-commerce, Fintech, Telecom, Non Profit, Real Estate, Social Media,
          Sports &amp; Fitness, Non-Profit, Marketing, Consulting and many
          more&hellip;
        </p>
      </div>
    </section>
    ...
    <section className="mw-mavenhive center ph4 mb5 tc">
      <p className="mw8 center f3 lh-mh ph6 mv0">
        “Watch the GrassHopper team share how MavenHive helped them build and
        launch the international version of their core telephony product”
      </p>
      <div className="mb3">
        <img src={Citrix} alt="" />
      </div>

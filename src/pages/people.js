...
export default () => (
  <div>
    ...
    <div className='mw-mavenhive center mt6 pa3 shadow-2'>
      <p className='f-1 lh-mh mh-gray tc measure-mh center'>MavenHive combines the flexibility of freelancing with the support of a close-knit team. Our team members decide where, when and how much they work. And in so doing, deliver far more for our clients than what would be thought possible.</p>
    ...
    <div className='mt5 pt3 tc'>
      <h2 className='ma0 f3 brand mb3'>Watch the team share their experience in MavenHive </h2>
    ...
    <section className='pv4-ns bg-brand white tc'>
      <div className='mw-mavenhive center ph4 pv2 ph5-l'>
        ...
        <div className='lh-copy f-1 mb4 pb2 ph5-l'>
          <p>We have a saying at MavenHive, “We are always Hiring!”<br/> That’s not because we are in need of more warm bodies to bill to clients ! But, because it is so difficult to find the right people to work with that you have to constantly be on the lookout for the next perfect fit.</p>
        </div>
        <p><Link to='/careers' className='dib link f-1 pv1 ph4 br2 fw5 tc w-100 w-auto-ns white ba'>Join our Team</Link></p>
      </div>
    </section>
  </div>
)

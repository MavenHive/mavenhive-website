    ...
    <footer className='h3-l pv2 content-box bt b--light-gray'>
      <div className='mw-mavenhive center ph4 flex-l items-center justify-between h-100 tc tl-l'>
        ...
        <ul className='list ma2 pa0'>
          ...
          <li className='dib mh2'><a className='dib link' href='https://twitter.com/Mavenhive' target='_blank'><img className='w2' src={TwitterIcon} alt='link to mavenhive twitter profile' /></a></li>
          <li className='dib mh2'><a className='dib link' href='https://www.linkedin.com/company/mavenhive-technologies-pvt-ltd/' target='_blank'><img className='w2' src={LinkedinIcon} alt='link to mavenhive LinkedIn profile' /></a></li>
          <li className='dib mh2'><a className='dib link' href='https://github.com/mavenhive' target='_blank'><img className='w2' src={GithubIcon} alt='link to mavenhive Github profile' /></a></li>
          <li className='dib ml2'><a className='dib link' href='https://www.youtube.com/channel/UCqdjB9e5zXnMA6CgVt-pp8Q/featured' target='_blank'><img className='w2' src={YoutubeIcon} alt='link to mavenhive YouTube channel' /></a></li>
        </ul>
      </div>
    </footer>
  )

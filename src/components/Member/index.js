...
export default ({ name, role, avatar, blurb, twitter, linkedin}) => (
  <div className='flex mv3'>
    ...
    <div className='w-90 pl3'>
      ...
      <p><a target='_blank' href={twitter}><img className='w1 h1 mr2' src={TwitterIcon} alt='link to twitter profile' /></a> <a target='_blank' href={linkedin}><img className='w1 h1' src={LinkedinIcon} alt='link to linkedin profile' /></a></p>
    </div>
  </div>
)
